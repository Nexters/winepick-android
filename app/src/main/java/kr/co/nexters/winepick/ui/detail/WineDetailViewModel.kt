...
class WineDetailViewModel @Inject constructor(
    ...
    fun getWineResult(wineResult: WineResult) {
        ...
        _wineValue.value = mutableListOf<WineValue>().apply {
            _wineResult.value?.sweetness?.let {
                add(
                    WineValue(
                        "당도",
                        context.getString(R.string.sweetness_detail),
                        it,
                        "높음",
                        "낮음",
                        false
            ...
            _wineResult.value?.acidity?.let {
                add(
                    WineValue(
                        "산도",
                        context.getString(R.string.acidity_detail),
                        it,
                        "높음",
                        "낮음",
                        false
            ...
            _wineResult.value?.body?.let {
                add(
                    WineValue(
                        "바디",
                        context.getString(R.string.body_detail),
                        it,
                        "무거움",
                        "가벼움",
                        false
            ...
            _wineResult.value?.tannin?.let {
                add(
                    WineValue(
                        "타닌",
                        context.getString(R.string.tannin_detail),
                        it,
                        "많음",
                        "적음",
                        false
    ...
    fun wineCountryImage(country: String) {
        when (country) {
            "미국" -> {
                _countryImage.value = R.drawable.us_icon
            }
            "이탈리아" -> {
                _countryImage.value = R.drawable.italy_icon
            }
            "남아프리카공화국" -> {
                _countryImage.value = R.drawable.south_africa_icon
            }
            "호주" -> {
                _countryImage.value = R.drawable.australia_icon
            }
            "이탈리아" -> {
                _countryImage.value = R.drawable.italy_icon
            }
            "칠레" -> {
                _countryImage.value = R.drawable.chile_icon
            }
            "스페인" -> {
                _countryImage.value = R.drawable.spain_icon
            }
            "뉴질랜드" -> {
                _countryImage.value = R.drawable.new_zealand_icon
            }
            "캐나다" -> {
                _countryImage.value = R.drawable.canada_icon
            }
            "프랑스" -> {
                _countryImage.value = R.drawable.france_icon
            }
            "오스트리아" -> {
                _countryImage.value = R.drawable.australia_icon
            }
            "독일" -> {
                _countryImage.value = R.drawable.germany_icon
            }
            "포루투갈" -> {
                _countryImage.value = R.drawable.portugal_icon
            }
            "아르헨티나" -> {
                _countryImage.value = R.drawable.argentina_icon
            }
