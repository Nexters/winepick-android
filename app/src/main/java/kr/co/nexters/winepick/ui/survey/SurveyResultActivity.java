...
public class SurveyResultActivity extends AppCompatActivity {
    ...
    ImageButton imgbtn_inflater_share;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgbtn_inflater_share = findViewById(R.id.share_button);
        /*imgbtn_inflater_share.setOnClickListener(new View.OnClickListener() {
            @Override
